...
export const useUiStore = defineStore('ui', () => {
  ...
  const mobileEventPanelOpen = ref(false);
  ...
  function openMobileEventPanel() {
    mobileEventPanelOpen.value = true;
  }

  function closeMobileEventPanel() {
    mobileEventPanelOpen.value = false;
  }
  ...
  return {
    ...
    openSystemMenu,
    closeSystemMenu,
    openMobileEventPanel,
    closeMobileEventPanel,
