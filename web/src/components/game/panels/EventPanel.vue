...
<template>
  <section class="sidebar-section" :class="{ 'sidebar-section--mobile': props.mobile }">
...
.sidebar-section--mobile .sidebar-header {
  flex-direction: column;
  align-items: stretch;
  gap: 8px;
}

.sidebar-section--mobile .filter-group {
  display: grid;
  grid-template-columns: 1fr;
  gap: 8px;
}

.sidebar-section--mobile .event-filter {
  width: 100%;
}

.sidebar-section--mobile .event-date {
  flex: 0 0 auto;
  min-width: 68px;
}

.sidebar-section--mobile .event-list {
