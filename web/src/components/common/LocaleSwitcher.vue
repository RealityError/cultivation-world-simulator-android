...
<template>
  <div
    ...
    :class="[
      `locale-switcher--${props.variant}`,
      { 'locale-switcher--mobile': props.mobile, 'is-open': isOpen, 'is-pulsing': shouldPulse },
    ]"
  >
    <button
...
.locale-switcher--splash.locale-switcher--mobile {
...
@media (max-width: 768px) {
  ...
  .locale-switcher--mobile .locale-trigger--splash {
    width: 188px;
    padding: 9px 12px;
  }

  .locale-switcher--mobile .locale-panel {
